...
update tb_marcas set nome = "ZARA" WHERE id = 3;
...
DELETE FROM tb_produtos where id=101;

use db_estoque;

select nome,preco,marca_id from tb_produtos where preco > 50 order by preco asc